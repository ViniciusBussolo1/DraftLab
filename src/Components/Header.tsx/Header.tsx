      ...
      <div className="max-w-[70rem] w-full">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-10">
            <span className="text-lg leading-normal font-bold uppercase text-purple-800 cursor-pointer hover:text-purple-500">
              Entrar
            </span>
            <button className="bg-purple-800 py-3 px-[1.125rem] rounded text-lg leading-[1.625rem] font-bold text-white uppercase hover:bg-purple-500">
              Aceito o Desafio
            </button>
          </div>
        </div>
        ...
        <div className="mt-20 grid grid-cols-2 gap-7">
          ...
          <div className="space-y-4">
            <h1 className="max-w-[30rem] text-5xl leading-[3.5rem] font-bold text-white">
